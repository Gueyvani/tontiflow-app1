...
/**
 * Vérifie localement, côté {@code financial-service}, les Access Token JWT
 ...
 * déjà validé de {@code user-service}/{@code tontine-service} : signature
 * RS256 et expiration sont vérifiées, l'émetteur ({@code iss}) ne l'est
 * volontairement pas, conformément au contrat JWT déjà validé.</p>
 */
