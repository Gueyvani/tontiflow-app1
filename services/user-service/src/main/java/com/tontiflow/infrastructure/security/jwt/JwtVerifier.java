...
/**
 * Vérifie localement, côté {@code user-service}, les Access Token JWT (RS256)
 * émis par {@code authentication-service}.
 *
 ...
 * {@code AccessTokenService.validate()} (authentication-service) et
 * {@code GatewayJwtVerifier.verify()} (api-gateway) : signature RS256 et
 * expiration sont vérifiées, l'émetteur ({@code iss}) ne l'est volontairement
 * pas, conformément au contrat JWT déjà validé.</p>
 */
