...
/**
 * Configuration Spring Security de {@code tontine-service} — socle
 ...
 * métier n'est introduite ici : {@code tontine-service} ne possède encore
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtVerifier jwtVerifier) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // dans authentication-service et user-service).
