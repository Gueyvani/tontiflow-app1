...
/**
 * Vérifie localement, côté {@code tontine-service}, les Access Token JWT
 ...
 * {@code GatewayJwtVerifier.verify()} (api-gateway) et le
 * {@code JwtVerifier} déjà validé de {@code user-service} : signature RS256
 * et expiration sont vérifiées, l'émetteur ({@code iss}) ne l'est
