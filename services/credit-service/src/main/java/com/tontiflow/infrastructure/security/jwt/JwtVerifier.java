...
/**
 * Vérifie localement, côté {@code credit-service}, les Access Token JWT
 * (RS256) émis par {@code authentication-service}.
 *
 ...
 * signature RS256 et expiration sont vérifiées, l'émetteur ({@code iss}) ne
 * l'est volontairement pas, conformément au contrat JWT déjà validé.</p>
 */
