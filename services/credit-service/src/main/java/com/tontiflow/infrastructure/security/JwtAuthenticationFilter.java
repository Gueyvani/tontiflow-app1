 ...
 * {@code tontine-service} et {@code financial-service}. Le filtre est
 * {@code OncePerRequestFilter} (exécution unique par requête) et strictement
 * stateless : aucune session n'est créée ni lue.</p>
 */
