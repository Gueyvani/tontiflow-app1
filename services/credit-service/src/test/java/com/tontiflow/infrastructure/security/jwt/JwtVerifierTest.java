...
class JwtVerifierTest {
    ...
    void verify_withValidToken_returnsUserContext() {
        ...
        String token = buildToken(privateKey, userId, Instant.now().plus(15, ChronoUnit.MINUTES),
                List.of("ROLE_USER", "ROLE_BORROWER"), List.of("CREDIT_READ", "CREDIT_REQUEST"));
        ...
        assertThat(userContext.roles()).containsExactlyInAnyOrder("ROLE_USER", "ROLE_BORROWER");
        assertThat(userContext.permissions()).containsExactlyInAnyOrder("CREDIT_READ", "CREDIT_REQUEST");
    }
