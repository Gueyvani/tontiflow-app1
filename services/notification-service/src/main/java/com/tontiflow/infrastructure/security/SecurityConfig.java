...
/**
 * Configuration Spring Security de {@code notification-service} — socle
 * d'authentification JWT local, calqué sur le patron déjà validé de
 * {@code user-service}, {@code tontine-service}, {@code financial-service}
 * et {@code credit-service}.
 *
 ...
 * métier n'est introduite ici : {@code notification-service} ne possède
 * encore aucun contrôleur métier.</p>
 */
@Configuration
@EnableWebSecurity
