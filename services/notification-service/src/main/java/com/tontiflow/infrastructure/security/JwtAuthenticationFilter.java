 ...
 * responsabilités que le patron déjà validé de {@code user-service},
 * {@code tontine-service}, {@code financial-service} et {@code credit-service}.
 * Le filtre est {@code OncePerRequestFilter} (exécution unique par requête)
 * et strictement stateless : aucune session n'est créée ni lue.</p>
 */
