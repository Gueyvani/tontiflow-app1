...
/**
 * Test d'intégration de la chaîne de sécurité JWT de
 * {@code notification-service} ({@link SecurityConfig}).
 *
 * <p>{@code notification-service} n'a aucun contrôleur métier ({@link
