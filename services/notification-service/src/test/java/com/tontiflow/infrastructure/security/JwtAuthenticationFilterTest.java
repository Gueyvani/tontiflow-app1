 ...
 * et reste non authentifié après un JWT invalide ou absent — sans passer par
 * un endpoint HTTP métier (qui n'existe pas encore dans
...
class JwtAuthenticationFilterTest {
    ...
    void doFilterInternal_withValidToken_populatesSecurityContextWithUserContext() throws Exception {
        ...
        String token = Jwts.builder()
                ...
                .claim(JwtClaimNames.PERMISSIONS, List.of("NOTIFICATION_READ"))
        ...
        assertThat(principal.permissions()).containsExactly("NOTIFICATION_READ");
        assertThat(authentication.getAuthorities())
                .extracting(Object::toString)
                .containsExactlyInAnyOrder("ROLE_USER", "NOTIFICATION_READ");
